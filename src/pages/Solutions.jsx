  ...
  return (
    <div className="w-full bg-white overflow-x-hidden">
      ...
      <section className="relative bg-[var(--navy-dark)] min-h-[60vh] flex items-center text-white py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <span className="text-[var(--accent)] font-bold uppercase tracking-[0.3em] text-sm mb-4 block animate-fade-in">Strategic Logistics</span>
            <h1 className="text-4xl md:text-7xl font-black mb-8 leading-tight uppercase tracking-tighter text-white animate-fade-in">
              Customized <br/>
              <span className="text-blue-300">Solutions</span> for Your Business
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 font-medium leading-relaxed mb-10 animate-fade-in">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {solutions.map((item, i) => {
              const directions = ['right', 'up', 'left', 'right', 'down', 'left'];
              return (
                <ScrollReveal 
                  key={i} 
                  direction={directions[i % directions.length]} 
                  delay={i * 100}
                  className="bg-white p-10 rounded-[40px] shadow-sm border border-[var(--primary)]/10 hover:shadow-2xl transition-all duration-500 group flex flex-col h-full"
                >
          ...
          <div className="bg-[var(--primary)] rounded-3xl md:rounded-[60px] p-6 sm:p-12 md:p-20 text-white relative overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <ScrollReveal direction="down" className="bg-white/10 p-6 rounded-3xl backdrop-blur-sm">
                 ...
                 <ScrollReveal direction="up" delay={200} className="bg-white/10 p-6 rounded-3xl backdrop-blur-sm sm:mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              <ScrollReveal 
                ...
                direction="up" 
                delay={i * 80}
                className="bg-white p-8 rounded-3xl text-center border border-[var(--primary)]/10 hover:border-[var(--accent)] transition-all group cursor-default h-full flex flex-col justify-center items-center"
              >
                 <div className="text-2xl text-gray-400 group-hover:text-[var(--accent)] transition-colors mb-4">
                   {item.icon}
                 </div>
      ...
      <section className="py-24 bg-white text-center">
        <ScrollReveal direction="up" className="container mx-auto px-6">
